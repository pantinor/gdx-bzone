...
public class ModelViewer3D extends ApplicationAdapter {
    ...
    // Scene content
    private GameModelInstance ba;
    private GameModelInstance ttle;
    private GameModelInstance zone;
    ...
    public void create() {
        ...
        ba = Models.buildWireframeInstance(Models.Mesh.SLOW_TANK.wf(), Color.GREEN, 1, -1f, 3f, 0.5f, 3f);
        ttle = Models.buildWireframeInstance(Models.Mesh.SUPER_TANK.wf(), Color.GREEN, 1, -1f, 3f, 0.5f, 3f);
        zone = Models.buildWireframeInstance(Models.Mesh.GIR_DRAXON.wf(), Color.GREEN, 1, -1f, 3f, 0.5f, 3f);
